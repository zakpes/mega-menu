...
$(function() {
    ...
    $(document).ready(function() {
      if ($(window).width() >= 992) {
        ...
        $(".nav-item-dropdown-lv-1").not(".nav-item-more").addClass("caret-right");
    ...
    $(".dropdown-submenu .dropdown-toggle").on("click", function(event) {
      ...
      // change caret to down/up
      if ($(this).hasClass("caret-down")) {
        $(this).toggleClass("caret-down");
        $(this).toggleClass("caret-up");
      }
  
      // change caret on other items
      if ($(this).parent().siblings().children(".dropdown-toggle").hasClass("caret-up")) {
        $(this).parent().siblings().children(".dropdown-toggle").removeClass("caret-up").addClass("caret-down");
      }
    ...
    $(".dropdown-toggle-lv-1").click(function() {
      ...
      $(this).parent(".nav-item-dropdown-lv-1").toggleClass("caret-right");
      $(this).parent(".nav-item-dropdown-lv-1").toggleClass("caret-left");
  
      if ($(this).parent(".nav-item-dropdown-lv-1").siblings(".nav-item-dropdown-lv-1").hasClass("caret-left")) {
        $(this).parent(".nav-item-dropdown-lv-1").siblings(".nav-item-dropdown-lv-1").removeClass("caret-left").addClass("caret-right");
      }
    });
  
    // change caret right/left on account item
    $("#dropdownMenu7-1").click(function() {
